        ...
        <div class="container">
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
                <div class="row">
                    ...
                    <div class="input-group input-group-icon">
                        <input type="text" placeholder="Email Adress" name="email" disabled style="cursor: not-allowed;" <?php echo "value='" . $_SESSION['email'] . "'" ?> />
                ...
                <br><br>
                <a href="../pages/account.php?accChoice=MyAccount" id='cnl'>cancel change</a>
            </form>
        </div>
    </section>
