...
<head>
    ...
    <meta name="description" content="DRS SHOP , n°1 du gaming Maroc , Comparez et achetez votre PC gamer en livraison rapide à domicile ou en magasin.">
    <meta name="author" content="DrissRaiss">
    <title>DRS SHOP</title>
...
<body>
        ...
        <div class="nav">
            ...
            <div class="float-right">
                <a <?php if (isset($_SESSION['connected']) && $_SESSION['role'] != 'user') {
                    ...
                    } ?> href="pages/cart.php" id="cart">Cart</a>
    ...
    <header>
        <div class="header">
            <h1>Welcome to the <span>DRS Shop</span> website</h1><br>
    ...
    <footer id="contacts">
        <div class="padding">
            ...
            <br><br>
            <p class="p2">Copyright &copy; DRS SHOP 2020-<?php echo date('Y') ?></p>
        </div>
    </footer>
    <script>
        function myFunction() {
